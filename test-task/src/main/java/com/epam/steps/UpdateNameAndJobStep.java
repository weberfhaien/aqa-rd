...
public class UpdateNameAndJobStep {
    ...
    @Given("I want to execute updateNameAndJob endpoint with user id ${userId}")
    ...
    @When("I submit the PATCH request and check that the status code is ${statusCode}")
